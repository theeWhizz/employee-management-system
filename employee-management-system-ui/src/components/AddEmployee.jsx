  ...
  return (
    <div className="flex max-w-2xl mx-auto shadow border-b">
      <div className="px-8 py-8">
        ...
        <div className="items-center justify-center h-14 w-full  space-x-4 pt-4 my-4">
          <button className="rounded text-white font-semibold bg-green-400 hover:bg-green-600 py-2 px-6">Save</button>
          <button className="rounded text-white font-semibold bg-red-400 hover:bg-red-600 py-2 px-6">Save</button>
        </div>
      </div>
    </div>
  )
